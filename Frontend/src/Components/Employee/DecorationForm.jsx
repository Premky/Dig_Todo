...
const DecorationForm = () => {
    ...
    const [currentDecoration, setCurrentDecoration] = useState([]);
    ...
    const onFormSubmit = async (data) => {
        ...
        try {
            const url = editing
                ? `${BASE_URL}/emp/update_decoration/${currentDecoration.id}`
                : `${BASE_URL}/emp/add_decoration`;
    ...
    const handleDelete = async (id) => {
        try {
            const url = `${BASE_URL}/emp/delete_decoration/${id}`;
                    ...
                    <div className="col-12">
                        <div className="d-flex flex-column px-3 pt-0">
                            <form className='row mt-1 g-3'>
                                ...
                                <div className="col-xl-3 col-md-4 col-sm-12">
                                    <label htmlFor="name"> विभुषणको प्रकार </label>
                                    <input
                                        {...register('name', { required: "This field is required." })}
                                        placeholder="पुरस्कारको प्रकार"
                                        className="form-control"
                                    />
                                ...
                                <div className="col-xl-3 col-md-4 col-sm-12">
                                    <label htmlFor="prize"> विभुषणको नाम </label>
                                    <input
